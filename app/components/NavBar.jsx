  ...
  return (
    <>
       ...
       <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm " : ""}`}>
            <a href="#top">
              <h1 className="w-28 mr-14 cursor-pointer text-2xl">YOUSEF .</h1>
            </a>
            ...
            <div className="flex items-center gap-4">
                {/* <button onClick={()=> setIsDarkMode(perv => !perv)}>
                  <Image src={IsDarkMode ? assets.sun_icon : assets.moon_icon} alt="dark/light" className="w-6"/>
                </button> */}
